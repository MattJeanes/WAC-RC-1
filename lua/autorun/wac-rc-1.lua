...
if wac and wac.aircraft then wac.aircraft.spawnCategoryRC = "WAC R/C" end
if wac and wac.aircraft then wac.aircraft.spawnCategoryRCU = "WAC R/C Unbreakable" end